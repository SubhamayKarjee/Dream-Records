                ...
                <div>
                    ...
                    <div className="md:px-3 md:pt-2 border">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <p className="my-1 text-sm font-semibold text-slate-500 ms-2">Account Holder Name</p>
                            ...
                            <p className="mt-2 text-sm font-semibold text-slate-500 ms-2">Account Number</p>
                            ...
                            <p className="mt-2 text-sm font-semibold text-slate-500 ms-2">Retype Account Number</p>
                            ...
                            <p className="mt-2 text-sm font-semibold text-slate-500 ms-2">Bank Name</p>
                            ...
                            <input type="text" className="input input-sm rounded-full input-bordered w-full" {...register("IFSC", { required: true})}/>
                            {errors.IFSC && <span className='text-red-600 pt-2 block text-sm'>IFSC Required</span>}
                            <p className="mt-2 text-sm font-semibold text-slate-500 ms-2">Branch Name</p>
                            ...
                            <input type="text" className="input input-sm rounded-full input-bordered w-full" {...register("swift_code", { required: true})}/>
                            {errors.swift_code && <span className='text-red-600 pt-2 block text-sm'>Swift Code Required</span>}
