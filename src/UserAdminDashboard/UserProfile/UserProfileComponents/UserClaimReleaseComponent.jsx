...
const UserClaimReleaseComponent = () => {
    return (
        <div>
            <div className="my-4">
            ...
            <div>
                <h2 className="text-lg font-semibold text-slate-500 px-2">You Claim Release</h2>
                <div className="p-3 border mt-2 rounded-lg">
                    <p className="my-1 text-sm font-semibold text-slate-500 ms-2">Demo</p>
                    <input type="text" placeholder="Demo" className="input rounded-full input-bordered w-full"/>
...
export default UserClaimReleaseComponent;