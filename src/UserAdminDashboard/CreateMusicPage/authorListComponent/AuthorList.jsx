...
const AuthorList = ({handleCancel, reFetchAuthor}) => {

    const { userNameIdRoll, authors, setAuthors } = useContext(AuthContext);
    ...
    },[userNameIdRoll, reFetchAuthor])


    const handleData = (data) => {
      if(authors){
        const dubleCheck = authors.some(a => a._id === data._id);
        if(dubleCheck){
