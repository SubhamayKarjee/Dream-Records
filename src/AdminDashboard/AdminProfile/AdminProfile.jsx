import { ArrowUpTrayIcon, PencilSquareIcon } from "@heroicons/react/24/solid";
...
const AdminProfile = () => {
    ...
    const {user, userNameIdRoll, mainProfileImage} = useContext(AdminAuthContext)
    ...
    useEffect(() => {
        console.log('id', userNameIdRoll[1]);
    ...
    return (
        <div className="md:h-full">
            <div className='md:h-full overflow-y-auto md:border-r px-3 md:pt-6 custom-scrollbar'>
                ...
                <div className="p-5 rounded-lg border">
                    <div className='flex items-center'>
                        ...
                        <div>
                            ...
                            <p className="">User Roll: {userData?.roll}</p>
                        </div>
                    </div>
